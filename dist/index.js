  ...
  class Command extends EventEmitter {
    ...
    constructor(name) {
      ...
      this._outputConfiguration = {
        ...
        getOutHasColors: () => {
          var _a, _b;
          return useColor() ?? (process.stdout.isTTY && ((_b = (_a = process.stdout).hasColors) == null ? void 0 : _b.call(_a)));
        },
        getErrHasColors: () => {
          var _a, _b;
          return useColor() ?? (process.stderr.isTTY && ((_b = (_a = process.stderr).hasColors) == null ? void 0 : _b.call(_a)));
        },
...
function requireCommander() {
  ...
  commander.InvalidOptionArgumentError = InvalidArgumentError;
  return commander;
}
requireCommander();
